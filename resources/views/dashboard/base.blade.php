            ...
            <div class="col-xl-3 col-sm-6 m-t35">
                <div class="card card-coin">
                    <div class="card-body text-center">
                        ...
                        <h2 class="text-black mb-2 font-w600">{{ $admin }}</h2>
                        <p class="mb-0 fs-14"></span>Total Admin
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-sm-6 m-t35">
                <div class="card card-coin">
                    <div class="card-body text-center">
                        ...
                        <h2 class="text-black mb-2 font-w600">{{ $teacher }}</h2>
                        <p class="mb-0 fs-13">
                            Total Guru
                        </p>
                    </div>
            ...
            <div class="col-xl-3 col-sm-6 m-t35">
                <div class="card card-coin">
                    <div class="card-body text-center">
                        ...
                        <h2 class="text-black mb-2 font-w600">{{ $student }}</h2>
                        <p class="mb-0 fs-14">
                            Total Siswa
                        </p>
                    </div>
            ...
            <div class="col-xl-3 col-sm-6 m-t35">
                <div class="card card-coin">
                    <div class="card-body text-center">
                        ...
                        <h2 class="text-black mb-2 font-w600">{{ $ulasan }}</h2>
                        <p class="mb-0 fs-14">Total Ulasan
                        </p>
                    </div>
                </div>
            </div>

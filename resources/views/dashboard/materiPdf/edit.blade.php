                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            <form action="{{ route('materi_pdf.update', $materi_pdf) }}" method="post"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="judul" value="{{ $materi_pdf->judul }}" id="judul"
                                            class="form-control" required>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="link" class="form-label">file pdf</label>
                                        <input type="file" name="file_url"
                                            value="{{ $materi_pdf->file_url }}" id="link" class="form-control">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="jenjang" class="form-label">Jenjang</label>
                                        <select name="jenjang_id" id="jenjang" class="form-control">
                                            @foreach($jenjangs as $jenjang)
                                                <option value="{{ $jenjang->id }}" {{ $materi_pdf->jenjang_id == $jenjang->id ? 'selected' : '' }}>
                                                    {{ $jenjang->nama }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="kelas_id" id="kelas" class="form-control">
                                            @foreach($kelas as $k)
                                                <option value="{{ $k->id }}" {{ $materi_pdf->kelas_id == $k->id ? 'selected' : '' }}>
                                                    {{ $k->nama }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group col-lg-12">
                                        ...
                                        <input type="text" value="{{ $materi_pdf->deskripsi }}" name="deskripsi"
                                            class="form-control">
                                    </div>
                                </div>
...
<script>
    ...
    function updateKelasOptions() {
        ...
        filteredKelas.forEach(kelas => {
            ...
            if (kelas.id == "{{ $materi_pdf->kelas_id }}") {

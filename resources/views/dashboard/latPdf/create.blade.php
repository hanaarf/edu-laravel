            ...
            <div class="col-lg-12 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Form materi pdf</h4>
                    </div>
                    <div class="card-body">
                        <div class="basic-form">
                            <form action="{{ route('latihan_pdf.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div id="soal-form-container">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="materi" class="form-label">Materi Pdf</label>
                                            <select name="materi_pdf_id" id="materi" class="form-control">

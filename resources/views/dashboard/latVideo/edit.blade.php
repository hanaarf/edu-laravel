                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            <form action="{{ route('latihan_video.update', $latihan_video->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')

                                <div class="form-group col-lg-12">
                                    <label>Pertanyaan</label>
                                    <textarea name="pertanyaan" id="editor">{{ $latihan_video->pertanyaan }}</textarea>
                                </div>
